<template>
    <el-table
            :data="data" border style="width: 100%" :row-style="showTr">
...
<script>
    import DataTransfer from '../../components/test1/dataTranslate.js'
    import Vue from 'vue'
    export default {
        name: 'tree-grid',
        props: {
...
// 是否默认展开所有树
        ...
        methods: {
            ...
            showTr: function (row, index) {
                let show = (row.parent ? (row.parent.expanded && row.parent.show) : true);
                row.show = show;
